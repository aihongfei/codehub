...
class AnySyntaxHighlighter extends StatelessWidget {
  ...
  AnySyntaxHighlighter(this.text,
      {Key? key,
   ...
   */
    ...
    int p = 0, currentLineNumber = 500 * index + 1, maxLength = text.length;
